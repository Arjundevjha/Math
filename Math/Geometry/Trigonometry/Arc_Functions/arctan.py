...
def calculate_arctan(
    ...
    # Optimization: Precompute -x_squared to avoid repeatedly allocating -Decimal(1)
    # and intermediate operations in the inner loop.
    neg_x_sq = -x_squared
    ...
    if number_of_terms is not None:
        ...
        # outside the loop to eliminate exponentiation on every iteration.
